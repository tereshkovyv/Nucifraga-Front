...
const firstImg = 'img/images/ImgInfoAboutUsPage/Block_1.png'
const secondImg = 'img/images/ImgInfoAboutUsPage/Block_5.png'
const thirdImg = 'img/images/ImgInfoAboutUsPage/Block_6.png'

const InfoAboutUs = () => {
    return (
        <section className={"infoAboutUs"} id={"infoAboutUs"}>
